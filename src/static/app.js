document.addEventListener("DOMContentLoaded", () => {
  ...
  function shareActivity(platform, activityName, activityDescription, schedule) {
    const pageUrl = window.location.href;
    const shareText = `Check out ${activityName} at Mergington High School! ${activityDescription} - ${schedule}`;
    ...
    switch(platform) {
      ...
      case 'facebook':
        ...
        break;
      case 'email':
        shareUrl = `mailto:?subject=${encodeURIComponent('Check out this activity!')}&body=${encodeURIComponent(shareText + '\n\n' + pageUrl)}`;
        break;
    }
  ...
  function renderActivityCard(name, details) {
    ...
    if (emailBtn) {
      emailBtn.addEventListener("click", (e) => {
        e.stopPropagation();
        shareActivity('email', name, details.description, formattedSchedule);
      });
    }
